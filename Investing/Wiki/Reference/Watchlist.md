...
| AEHR | Aehr Test Systems | Silicon carbide wafer testing; EV semiconductor demand | Long-term hold | 7.5 |
...
## Research Log
*Append macro pulse updates, price action notes, and thesis changes below.*

- **2026-05-07** — Watchlist initialized. Positions reflect active portfolio and watchlist as of today.

- **2026-05-07** — Added $ASTS (AST SpaceMobile) to High Upside Rockets watchlist. Satellite-to-cell direct 5G from space; partnerships with AT&T, Verizon, Rakuten.

- **2026-05-07** — Added $NVDA (NVIDIA) to Core Holdings watchlist. AI compute platform dominant. See NVDA Ecosystem Map note for derivative plays.

---

## Macro Pulse — May 7, 2026
...
```json
{
  "macro_context": {
    ...
    "top_catalysts": [
      "NVDA invests $2.1B in IREN — 5GW AI infrastructure partnership announced after close; IREN +26% AH",
      "AMD Q1 beat (+$1.37 vs $1.30 est) drove S&P 500 to first-ever close above 7,300 yesterday; semis taking a breather today"
    ],
    "sector_regime": "tech-favorable",
    "one_liner": "NVDA-IREN $2.1B deal validates AI infrastructure thesis; semis consolidating after AMD-driven record; Iran peace deal hopes cap downside",
    "data_as_of": "2026-05-07T16:30:00-04:00"
  }
}
```

**Backdrop:** S&P 500 closed at 7,337 (-0.38%) today after yesterday's record above 7,300 powered by AMD's earnings beat. VIX at 17.3 — calm. Crude oil -4.7% to ~$91.60 on US-Iran peace deal optimism. 10-year yields at 4.33%, 2-year at 3.845%. Q1 unit labor costs +2.3% (below 2.6% estimate) — modestly friendlier inflation print ahead of next week's CPI/PPI. NVDA earnings scheduled May 20 after close — the next big market event on the calendar.
- 2026-05-09 — Added $HOOD (Robinhood Markets, Inc.). Robinhood Markets, Inc. aims to transform from a commission-free trading app into a comprehensive financial platform by leveraging its large, tech-savvy user base to drive growth through expanded offerings and improved monetization.

- **2026-05-11** — Added $VIAV (Viavi Solutions) to Compounders Watchlist. Optical test & measurement picks-and-shovels for AI fabric buildout; 1.6T Ethernet + silicon photonics test platforms. See [[Space & Comms/VIAV]].
