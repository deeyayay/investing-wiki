...
## Ecosystem Links
- [[Semiconductor Foundry/_Supply Chain Map]] — specialty/mature-node tier
- Upstream: silicon wafers (SiC substrates from Wolfspeed, II-VI for SiC process); specialty gases (LIN)
- Downstream: automotive Tier 1s (Bosch, Continental, Denso), medical device makers, IDMs fabbing out
- Peers: GlobalFoundries (GFS), Tower Semiconductor (Intel), SMIC (analog), SkyWater (US specialty)
