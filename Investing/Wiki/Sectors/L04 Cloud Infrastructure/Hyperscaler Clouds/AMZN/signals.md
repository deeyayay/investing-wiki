...
- **2026-08-27** — Amazon says its in-house AI chip (Trainium) business is growing fast (simplywall.st).
  **Why it matters:** Directly confirms the custom-silicon moat leg of the thesis — Trainium adoption accelerating supports the AWS margin-advantage argument over third-party GPU reliance.

- **2026-08-26** — Amazon acquires DuckLabs (Seeking Alpha).
  **Why it matters:** New M&A fact — no detail yet on what DuckLabs does or the deal terms; logged for the audit trail. Note: EDGAR timed out for AMZN tonight, so there's no primary filing to check the acquisition against.
...
- **2026-09-22 (post-open)** — 📰 BRIEF | 5 items triaged, 0 new logged — three more MarketBeat institutional-position stories (Pinnacle Holdings, Vega Investment, Dearborn Partners) repeat the routine 13F-type pattern dismissed 09-21; Erste Group earnings-estimate-lift and "stock gains as earnings approach" recap headlines were noise
- **2026-09-22 (evening)** — 📰 BRIEF | 5 items triaged, 0 new logged — the Kuehne+Nagel logistics-partnership headline recirculates the already-logged 09-21 evening item; three more MarketBeat institutional-position stories repeat the routine 13F-type pattern; an IDCC-dividend mention was a company mismatch; EDGAR timed out
- **2026-09-23 (post-open)** — 📰 BRIEF | 5 items triaged, 0 new logged — three more MarketBeat institutional-position stories (Vega, Dearborn, Kelly Lawrence) repeat the routine 13F-type pattern; "stock gains as earnings approach"/"holds above $254 as earnings beat estimates" headlines are unconfirmed pre-earnings content-mill hype — no real print evidenced since the 09-07 confirmed beat, treated as noise
- **2026-09-23 (evening)** — 📰 BRIEF | 5 items triaged, 0 new logged — the Missouri data-center-expansion headline recirculates the already-logged 08-31 item; "holds above $254 as earnings beat estimates" repeats the already-dismissed pre-earnings content-mill pattern; a Kelly Lawrence institutional-position mention was routine 13F-type noise; "AI and delivery spending" piece was opinion
