...
| 2026-09-18 | Analysis: 3 companies have locked up 85% of HBM supply | ↑ | An oligopoly-concentration framing sharpens the supply-scarcity/pricing-power leg of the demand thesis; independent of the standing pace-setter/alt-HBM-tech /dig queue |
| 2026-09-23 | SK hynix's Indiana HBM plant hit with a lawsuit (basis unconfirmed) | → Neutral | Sharpens the standing "only US-domiciled" watch item from 08-28; a legal challenge could delay the competing plant, but magnitude is unknown at headline level — folded into the open /dig queue, not a drift change |
