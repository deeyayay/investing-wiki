...
| 2026-06-16 | JV Dependency | 285A.T | Flash Ventures — 8 factories in Japan, 49.9% SNDK ownership, JV extended through 2034 ($1.17B guaranteed payments); ~100% of SNDK NAND wafer supply originates here | Single-point-of-failure risk: geopolitical event, natural disaster, or Kioxia operational failure has no near-term substitute. JV extension locks in supply AND locks in the dependency. Watch 285A.T earnings, capex guidance, and Japan macro for read-through to SNDK supply. |
| 2026-06-16 | Competes | 285A.T | Kioxia sells enterprise SSDs from the same factories, using co-developed NAND, to the same hyperscaler customers | "Partner in the morning, rival in the afternoon." Kioxia market share wins are partially SNDK IP wins (JV economics) but also direct revenue competition. If Kioxia wins a major hyperscaler contract, SNDK loses the sale — but the underlying NAND was made in a half-owned factory. |
