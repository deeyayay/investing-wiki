...
|------|-------|-------------|-----|
| 2026-09-16 | ZeroFlap portfolio expands with 224G-based 1.6T optical transceivers | ↑ | First shipping product since the DustPhotonics close that confirms the optical vertical-integration leg is real hardware, not just a balance-sheet/accounting story |
