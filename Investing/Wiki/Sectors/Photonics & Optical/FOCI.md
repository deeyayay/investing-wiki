# FOCI — FOCI Fiber Optic Communications, Inc.
*Last updated: May 21, 2026*

---

## One-Line Thesis
The dominant fiber array unit (FAU) supplier at the TSMC COUPE bottleneck — ReLFACon precision technology positions FOCI as the mechanical-optical chokepoint in every co-packaged optics module built for hyperscaler AI clusters.
...
The bull case is concentrated on TSMC's COUPE (COmpact Universal Photonic Engine) architecture, which is the de facto CPO standard for NVIDIA's next-generation Spectrum-X and Rubin platforms. FOCI has been identified by Citrini Research and Hunterbrook Media as a key FAU supplier within COUPE, alongside Himax Technologies — which took a 5.3% equity stake in FOCI via private placement, explicitly to unite FOCI's CPO technology with Himax's wafer-level optics (WLO) for TSMC COUPE integration. That equity investment is the most concrete supply-chain validation signal available for a Taiwanese OTC-listed company with limited English disclosure. FOCI plans to begin small-scale FAU production in 2025 and mass-produce 1.6T and 3.2T FAUs in H2 2026, targeting a "revenue surge within 3 years."

The company's 2025 revenue was TWD 1.89B (~$58M USD) growing +38.7% YoY — the growth rate accelerating as CPO design-wins convert from sampling to initial volume. At a ~TWD 87B (~$2.7B USD) market cap, the market is pricing in the full CPO ramp thesis with limited margin of safety: the implied EV/Revenue is approximately 46x on 2025 revenue. The valuation requires H2 2026 FAU mass-production to materialize on schedule and TSMC COUPE to become the dominant CPO architecture as NVIDIA scales Spectrum-X and Rubin across hyperscaler clusters.

**Key moat:** ReLFACon precision technology for high-yield FAU manufacturing; 30-year compound semiconductor fiber expertise; strategic equity position in Himax partnership for TSMC COUPE; ITRI heritage gives ongoing access to Taiwan's deep photonics research network.

**Key risks:** Extreme valuation (~46x EV/Revenue on 2025 revenue) prices in flawless CPO execution; TSMC COUPE adoption timeline uncertainty; grating-coupled CPO architectures could displace FAU requirement (structural substitute risk); limited English disclosure and TPEX listing creates information asymmetry; FAU commoditization if multiple suppliers qualify; single-architecture concentration on COUPE.
...
| Role | Name | Notes |
|------|------|-------|
| President | Spencer Wu | President; ITRI founding team heritage; 30-year optical fiber domain |
| Board | Li-Jen Kuo, Tzu-Ming Wang, Tien-Chang Huang, Chi-Jen Chou | Board composition; full profiles pending primary source verification |

**Execution track record:** FOCI was founded in 1995 by a core team from ITRI — Taiwan's most prestigious applied research institute — giving the company a deep institutional engineering foundation. The 30-year track record in precision fiber optics is the primary execution credential; the company navigated multiple telecom boom/bust cycles and has survived long enough to be positioned at the CPO inflection. The Himax equity partnership (a publicly traded, well-resourced strategic) is an execution signal: Himax is not placing capital in FOCI without independent validation of the FAU technology.

**Insider ownership / alignment:** — (not an SEC filer; listed on TPEX, Taiwan. Insider ownership and governance details sourced from TPEX filings; not available in English. Himax holds 5.3% equity post private placement. Full ownership structure pending primary-source verification via TPEX/company IR.)
...
## Earnings & Financials
*(Append after each earnings event — TPEX quarterly disclosure calendar)*
...
## SEC Filings
⚠️ *FOCI is listed on TPEX (Taipei Exchange) — not an SEC filer. Monitor TPEX regulatory filings and company IR at foci.com.tw. Financial disclosures are in Traditional Chinese.*
...
- **2026-03** — Himax Technologies announces strategic investment in FOCI via private placement (5.3% equity). Partnership to combine FOCI ReLFACon FAU technology with Himax nano-scale WLO for TSMC COUPE MCM integration.
  **Why it matters:** Himax is a credible, well-capitalized listed technology company with deep TSMC supply chain access. Its equity bet on FOCI validates that ReLFACon is a viable FAU solution for COUPE and de-risks the question of whether FOCI has a real position in the NVIDIA CPO architecture or is just a candidate.
...
## Ecosystem Links
- TSMC COUPE architecture — the CPO standard FOCI's FAU is designed for
- Himax Technologies — strategic equity partner; WLO integration for COUPE
- [[NVDA]] — Spectrum-X and Quantum-X CPO switches are the demand end-market
- [[AXTI]] — upstream InP substrate; both are CPO supply chain chokepoints at different layers
- [[COHR]], [[LITE]] — downstream CPO module integrators that require FAU as input
