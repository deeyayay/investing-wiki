...
| Photonic Detection, Measurement & Test | Characterize, verify, and screen photonic devices and optical systems — from single-component spectral/power parameters through wafer-level opto-electrical yield verification and in-field coherent link quality assurance | Optical spectrum analysis (grating monochromator + linear InGaAs CCD, 1200–1700nm, 0.02–0.05nm resolution, 73dB stray-light rejection); optical power monitoring (integrating sphere + calibrated InGaAs PD, multi-channel, ±0.01 dB accuracy); BER/OSNR coherent link testing (MT1040A-class: software-defined receiver + DSP, FEC error rate readout, OSNR measurement on live 100ZR/400ZR/800ZR links); wafer-level photonic probing (9-axis nano-precision fiber alignment, <1 dB coupling loss, single-click auto-cal; LIV curve sweep; modulator Vpi/bandwidth/IL/ER characterization; SPAD/APD responsivity map); coherent transceiver qualification (OSNR penalty, pre/post-FEC BER vs. received power, wavelength accuracy, drift stability) | Optical spectrum analyzer (OSA, grating-based benchtop, e.g. AQ6361/AQ6370E series); OSNR/BER tester (Network Master Pro MT1040A, 100ZR–800ZR coherent); wafer-level photonic test cell (V93000-Triton: Advantest ATE chassis + FormFactor OptoVue Pro 9-axis optical alignment probe); tunable laser source (TLS, <100 kHz linewidth, 1520–1620nm); optical power meter (calibrated NIST-traceable, multi-channel); SiPh modulator characterization system; CPO opto-electrical continuity and yield test fixture | Partial | High | Calibration IP + Process IP (photonic alignment yield and calibration artifact traceability are hard-won process skills; OSA wavelength accuracy is tied to national metrology standards; wafer-level SiPh/CPO test is becoming a chokepoint — no CPO batch ships without per-wafer opto-electrical yield verification) | High |
...
| Photonic Sensing & LIDAR | 6965.T | Hamamatsu Photonics | Mid | Yes | InGaAs APD arrays and SiPM detectors; dominant photosensor foundry for 1550nm LiDAR systems |
| Photonic Detection, Measurement & Test | 6841.T | Yokogawa Electric | Mid | No | Industry-standard OSA for production testing of datacenter transceivers (AQ6361/AQ6370E series) |
| Photonic Detection, Measurement & Test | 6754.T | Anritsu | Mid | No | Coherent link tester (MT1040A/MT1000A): BER/FEC/OSNR for 100ZR–800ZR pluggable transceiver qualification |
| Photonic Detection, Measurement & Test | 6857.T | Advantest | Large | No (Semis CANDIDATE) | ⚠️ **Cross-sector**: primary revenue in Semiconductors ATE; wafer-level SiPh/CPO test via V93000-Triton (with FormFactor, launched April 2025) |
| Photonic Detection, Measurement & Test | FORM | FormFactor | Large | No | Wafer probe + OptoVue Pro 9-axis photonic alignment for SiPh/CPO yield test; Keystone Photonics acquisition (Dec 2025) |
...
## Research Log
- **2026-05-31** — Added Photonic Detection, Measurement & Test tier (9th tier). Source: Japanese landscape infographic (Detection, Measurement, and Test Scale Map — "From Photodetector Physics to Wafer-Level Verification in Photonics-Electronics Convergence"). Companies identified: Yokogawa (6841.T) OSA, Anritsu (6754.T) coherent link test, Advantest (6857.T) + FormFactor (FORM) wafer-level SiPh/CPO ATE (V93000-Triton, April 2025). Advantest noted as cross-sector (primary: Semiconductors ATE; secondary: Photonics). Hamamatsu (6965.T) added to Sensing & LIDAR nodes. Research path (TDK spintronic detector) noted but not yet commercial — not added as a traded node.
